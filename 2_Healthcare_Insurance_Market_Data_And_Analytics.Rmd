...
```{r}
# Import Data Set 1
CPSC_Enrollment <- read.csv("data/CPSC_Enrollment_2019_10/CPSC_Enrollment_Info_2019_10.csv")
...
```{r}
# Import Data Set 2
Monthly_Report <- read.csv("data/Monthly_Report_By_Plan_2019_10/Monthly_Report_By_Plan_2019_10.csv")
#View(Monthly_Report)
head(Monthly_Report)
```
